...
function TasksSidebar(props) {
  ...
  const loadMore = () => {
    const token =
      "OA.YWauKgOJ1E1AB7PBhAt5vlGbS4qrTxVPyyBKffhg3Dcqll0OnN2ZyfA8hKxe";

    axios
      .get(`task?page=${currentPage}&limit=${pageSize}`, {
        headers: {
        ...
        items.map((item) => (
          <>
            <div
              ...
              onClick={() => handleCombinedActions(item.id, item)}>
              ...
              <div className={styles.side_div_item}>
                ...
                <div className={styles.side_div_item_div}>
                  ...
                  />
                  <div className={styles.side_div_item_date}>
